...
alsh_args_2=(2 3 4 6 8 12 16 24 32) # number of hash functions in one hash table
...
quant_args_1=(16 32 64 128) # subspace count
...
for a in "${kmeans_args_1[@]}"; do
    for b in "${kmeans_args_2[@]}"; do
            echo "Running kmeans $a $b $kmeans_args_3"
